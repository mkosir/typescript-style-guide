...
It provides a shared reference while loading only the sections relevant to the task, making decisions less arbitrary and more consistent across a codebase.
