...
For external API services e.g. REST, GraphQL etc. it's crucial to generate types from their contracts, whether it's Swagger, schemas, or other sources. Avoid manually declaring and maintaining them, as it's easy to get them out of sync.
