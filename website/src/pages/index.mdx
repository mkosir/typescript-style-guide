...
An Agent Skill for this guide is in development. It will help coding agents apply, review, and explain its conventions while loading only the sections relevant to the task.

The skill complements TypeScript, linters, and formatters rather than replacing them. Automated rules should still be enforced by the appropriate tooling.
