...
Discriminated unions are a powerful concept you may encounter in various programming languages, often under different names such as tagged unions, sum types in C, Rust, Haskell etc.
