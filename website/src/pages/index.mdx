...
The Agent Skill complements TypeScript, linters, and formatters. Those tools enforce automatable rules. The skill helps coding agents apply, review, and explain conventions that depend on context and judgment.
...
The `any` type must not be used because it bypasses type checking and allows unsafe operations and assignments. This can hide serious programming errors.
