...
Install either the [complete guide](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-style-guide):

```sh
npx skills add mkosir/typescript-style-guide --skill typescript-style-guide
```

Or the focused [Discriminated Unions skill](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-discriminated-unions):
