...
- Majority of function arguments should be required (use optional sparingly). [&#11107;](#required--optional-props)
...
- When applicable use **discriminated type** to eliminate optional args, which will decrease complexity on function API and only necessary/required args will be passed depending on its use case.
...
- Use component composition sparingly, where its emphasized how component API improved (performance improvement, better app scalability etc.).
