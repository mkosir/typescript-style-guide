...
<p>
  As rule of a thumb, use type annotation if it narrows the type.
  <Chip>
    Just because you don't need to add types, doesn't mean you shouldn't. Explicit type annotations increase code
    readability and intent, but still in some cases inference has its place.
  </Chip>
</p>
