...
React components are functions, where [respective conventions apply](#functions).
...
- Data fetching is only allowed in container components. UI components should show derived state and send events, nothing more.
