...
- use literal type most frequently
- const assertion arrays when there is a need to loop through the values
- const assertion objects when there is a strong use case for it
