...
The [Agent Skill](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-style-guide) helps coding agents apply, review, and explain the conventions in this guide. It complements TypeScript, linters, and formatters, which enforce automatable rules.
...
The skill loads only the guide sections relevant to the task, not the entire guide, keeping the coding agent's context focused. This provides a shared reference for more consistent decisions across a codebase.
