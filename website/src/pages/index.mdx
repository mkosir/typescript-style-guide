...
An Agent Skill for this guide is in development. It will help coding agents apply, review, and explain these conventions.
Agent Skills load brief instructions first, then only the guide sections relevant to the task, keeping context usage focused.
The skill complements TypeScript, linters, and formatters, which remain responsible for automated enforcement.
