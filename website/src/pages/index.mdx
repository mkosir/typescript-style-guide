...
- [Complete guide](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-style-guide): `npx skills add mkosir/typescript-style-guide --skill typescript-style-guide`
- [Types](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-types): `npx skills add mkosir/typescript-style-guide --skill typescript-types`
- [Discriminated Unions](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-discriminated-unions): `npx skills add mkosir/typescript-style-guide --skill typescript-discriminated-unions`
- [Functions](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-functions): `npx skills add mkosir/typescript-style-guide --skill typescript-functions`
- [Variables](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-variables): `npx skills add mkosir/typescript-style-guide --skill typescript-variables`
- [Naming](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-naming): `npx skills add mkosir/typescript-style-guide --skill typescript-naming`
- [Source Organization](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-source-organization): `npx skills add mkosir/typescript-style-guide --skill typescript-source-organization`
- [React](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-react): `npx skills add mkosir/typescript-style-guide --skill typescript-react`
- [Tests](https://github.com/mkosir/typescript-style-guide/tree/main/skills/typescript-tests): `npx skills add mkosir/typescript-style-guide --skill typescript-tests`
...
- **Embrace discriminated unions**. [&#11107;](#discriminated-unions)
